...
|------|---------|-------------|
| file_renamer.py | File Renamer | Prompts user for a folder path and auto-renames all .txt files sequentially |
| basic_calculator.py | Basic Calculator | Performs addition, subtraction, multiplication and division on user input |
...
- Character pool construction for password logic
- `any()` for checking conditions across iterables
